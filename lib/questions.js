...
export const QUESTIONS = [
  ...
  // ---------- GenLayer & AI (batch 2) ----------
  {
    id: "gl-11",
    category: "genlayer",
    question: "What is GenLayer primarily designed to bring to blockchain?",
    options: [
      "Faster Bitcoin mining",
      "Intelligent and subjective decision-making",
  ...
  },
  {
    ...
    category: "genlayer",
    question:
      "What technology allows GenLayer Intelligent Contracts to work with information beyond deterministic blockchain data?",
    options: ["AI/LLMs", "Bitcoin mining", "GPU rendering", "Email servers"],
    correctIndex: 0,
  },
  {
    id: "gl-13",
    category: "genlayer",
    question: "What is a key difference between traditional smart contracts and GenLayer Intelligent Contracts?",
    options: [
      "Intelligent Contracts can process subjective information using AI",
      "Traditional smart contracts cannot hold tokens",
      "Intelligent Contracts don't run on a blockchain",
      "Traditional smart contracts require no code",
    ],
    correctIndex: 0,
  },
  {
    id: "gl-14",
    category: "genlayer",
    question: "What consensus mechanism does GenLayer use to reach agreement on AI-generated results?",
    options: ["Proof of Work", "Optimistic Democracy", "Proof of Stake only", "Random guessing"],
    correctIndex: 1,
  },
  {
    id: "ai-9",
    category: "ai",
    question: "Why is consensus important when AI is involved in blockchain applications?",
    options: [
      "AI outputs can vary, so the network needs a way to agree on results",
      "It makes images generate faster",
      "It eliminates the need for validators",
      "It increases Bitcoin's supply",
    ],
    correctIndex: 0,
  },
  {
    id: "gl-15",
    category: "genlayer",
    question: "Which of these is a potential use case for GenLayer?",
    options: [
      "AI-powered prediction markets",
      "Replacing computer keyboards",
  ...
  },
  {
    ...
    options: [
      "Contracts that combine blockchain execution with AI-based reasoning",
      "Contracts that only store JPEG images",
      "Traditional legal contracts written by lawyers",
  ...
  },
  {
    id: "gl-17",
    category: "genlayer",
    question: "What problem does GenLayer aim to address with AI and blockchain?",
    options: [
      "Making blockchains capable of handling more subjective and real-world information",
      "Making phones use less battery",
  ...
  },
  {
    id: "ai-10",
    category: "ai",
    question: "Which statement best describes an AI agent?",
    options: [
      "A system capable of perceiving information and taking actions toward a goal",
  ...
  },
  {
    id: "ai-11",
    category: "ai",
    question: "Why can AI agents benefit from blockchain infrastructure?",
    options: [
      "Blockchain can provide verifiable ownership, transactions, and programmable rules",
      "Blockchain gives AI unlimited intelligence",
      "Blockchain removes the need for data",
      "Blockchain automatically makes every AI model accurate",
    ],
    correctIndex: 0,
  },
];
